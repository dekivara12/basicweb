          ...
          <div class="row my-5">
               <div class="col-md-6 text-center login bg-dark">
                    ...
                    <form action="" method="post">
                         ...
                         <button class="btn btn-primary text-uppercase" type="submit" name="login">Login As Admin</button>
                         <button class="btn btn-primary text-uppercase" type="submit" name="login">Login As User</button>
