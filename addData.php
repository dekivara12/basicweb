...
<body style="background-color:#5F9EA0">
     ...
     <nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
          <div class="container">
               <a class="navbar-brand" href="index.php">Sistem Admin Manajemen Dokumen</a>
               ...
               <div class="col-md">
                    <form action="" method="post" enctype="multipart/form-data">
                         <div class="mb-3">
                              ...
                              <input type="number" class="form-control w-50" id="nis" placeholder="Masukkan NIP" min="1"
                         ...
                         <div class="mb-3">
                              <label for="jurusan" class="form-label">Posisi</label>
     ...
     <div class="container-fluid">
          <div class="row bg-dark text-white text-center">
               <div class="col my-2" id="about">
                    ...
                    <p>
                    Copyright 2024 - Dekivara Zaka Aulia Igani
                    </p>
               </div>
          </div>
     </div>
     ...
     gsap.to('.Tambah_data', {
          duration: 2,
          delay: 1,
          text: '<i class="bi bi-person-plus-fill"></i>Tambah Data Pegawai'
     })
     gsap.from('.navbar', {
          duration: 1,
          y: '-100%',
